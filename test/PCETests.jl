...
coeffs = Dict{Any, Any}(pce.sym_basis[i]*pce.sym_basis[2] => pce.moments[1][i] for i in 1:n+1)
coeffs[Val(1)] = 4.0
basis_indices = Dict{Any,Any}(pce.sym_basis[i]*pce.sym_basis[2] => ([i-1, 1], [1,i-1]) for i in 1:n+1)
